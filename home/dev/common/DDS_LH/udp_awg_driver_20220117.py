...
userDLL_path = str(Path(__file__).parent/'udpdll_20210822.dll')
...
#        clk_tcp_client_socket.send(tcp_buffer)
        ...
        self.dac_trigger_ctrl_ins(self.dev_id.clock_board[0],0,4,10,0)
...
#            print(self.dev_id.clock_board[i+1])
            ...
            time.sleep(2)
            self.dac_trigger_ctrl_ins(self.dev_id.clock_board[i],0,4,10,0)
