...
class Driver(BaseDriver):
    CHs = list(range(1, 25))
    segment = ('ns', '0|111|112|113|114|115')
    ...
    quants = [
        ...
        Quantity('PipInstall', value='', ch=1),  # qsync固件更新
        Quantity('Timeout', value=10, unit='s')
    ]
    ...
    def set(self, name, value=0, channel=1):
        ...
        if name in {
                ...
                'DemodulationParam', 'Coefficient', 'Instruction'
        }:
    ...
    def _show_system_status(self):
        import json
        keys = [
            'device_type', 'backend_version', 'ad_num', 'da_num', 'cpu_temp',
            'memory_use'
        ]
